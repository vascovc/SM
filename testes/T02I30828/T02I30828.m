function varargout = T02I30828(varargin)
% T02I30828 MATLAB code for T02I30828.fig
%      T02I30828, by itself, creates a new T02I30828 or raises the existing
%      singleton*.
%
%      H = T02I30828 returns the handle to a new T02I30828 or the handle to
%      the existing singleton*.
%
%      T02I30828('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in T02I30828.M with the given input arguments.
%
%      T02I30828('Property','Value',...) creates a new T02I30828 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before T02I30828_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to T02I30828_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help T02I30828

% Last Modified by GUIDE v2.5 15-Jun-2015 13:55:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @T02I30828_OpeningFcn, ...
                   'gui_OutputFcn',  @T02I30828_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before T02I30828 is made visible.
function T02I30828_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to T02I30828 (see VARARGIN)

% Choose default command line output for T02I30828
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes T02I30828 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = T02I30828_OutputFcn(hObject, eventdata, handles) 
...
[md,k]=goldensearch(@tifiting,5,7,1,1e-3);
