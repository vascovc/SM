function varargout = T02H30828(varargin)
% T02H30828 MATLAB code for T02H30828.fig
%      T02H30828, by itself, creates a new T02H30828 or raises the existing
%      singleton*.
%
%      H = T02H30828 returns the handle to a new T02H30828 or the handle to
%      the existing singleton*.
%
%      T02H30828('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in T02H30828.M with the given input arguments.
%
%      T02H30828('Property','Value',...) creates a new T02H30828 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before T02H30828_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to T02H30828_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help T02H30828

% Last Modified by GUIDE v2.5 15-Jun-2015 12:46:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @T02H30828_OpeningFcn, ...
                   'gui_OutputFcn',  @T02H30828_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before T02H30828 is made visible.
function T02H30828_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to T02H30828 (see VARARGIN)

% Choose default command line output for T02H30828
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes T02H30828 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = T02H30828_OutputFcn(hObject, eventdata, handles) 
...
for i=1:(length(t)-1)
    ...
    % Animacao
    plot(handles.animacao,[0 0 10 10],[3 1 1 3],'-k',...
        [0 x(i+1)],[1.5 1.5],'-b',[x(i+1) 10],[1.5 1.5],'-m')
    ...
    % Grafico
    E(i+1)=0.5*((k(1)+k(2))*(x(i+1)-L)^2+m*v(i+1)^2);
...
[md,k]=goldensearch(@thfiting,5,7,1,1e-3);
