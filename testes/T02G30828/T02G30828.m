function varargout = T02G30828(varargin)
% T02G30828 MATLAB code for T02G30828.fig
%      T02G30828, by itself, creates a new T02G30828 or raises the existing
%      singleton*.
%
%      H = T02G30828 returns the handle to a new T02G30828 or the handle to
%      the existing singleton*.
%
%      T02G30828('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in T02G30828.M with the given input arguments.
%
%      T02G30828('Property','Value',...) creates a new T02G30828 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before T02G30828_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to T02G30828_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help T02G30828

% Last Modified by GUIDE v2.5 02-Jun-2015 16:55:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @T02G30828_OpeningFcn, ...
                   'gui_OutputFcn',  @T02G30828_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before T02G30828 is made visible.
function T02G30828_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to T02G30828 (see VARARGIN)

% Choose default command line output for T02G30828
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes T02G30828 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = T02G30828_OutputFcn(hObject, eventdata, handles) 
...
for i=1:(length(t)-1)
    ...
    % Grafico
    E(i+1)=0.5*((10+0.01*(x(i)-L))*(x(i+1)-L)^2+m*v(i+1)^2);
...
[md,k]=goldensearch(@tgfiting,9,11,1,1e-3);
